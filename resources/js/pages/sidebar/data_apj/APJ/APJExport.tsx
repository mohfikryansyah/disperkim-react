...
export default function APJExport({ subdistricts, panels, titleForButton, routeName, buttonIcon, buttonClassName, processingText }: ExportPDFProps) {
            ...
            <DialogContent>
                ...
                <DialogFooter>
                    <Button
                        ...
                        disabled={exportIsProccessing.state}
                    >
                        <img src={buttonIcon} className="size-5" alt="PDF Icon" />
                        {exportIsProccessing.state ? processingText : titleForButton ? titleForButton : 'Export PDF'}
                    </Button>
                </DialogFooter>
            </DialogContent>
