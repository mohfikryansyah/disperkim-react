...
export default function MapLamp({ lamps, zoom = 12, center = [0.556174, 123.058548], children, mapRef }: MapLampProps) {
    useEffect(() => {
        const timer = setTimeout(() => {
            ...
            lamps.forEach((marker) => {
                        ...
                        <div className="mb-4 space-y-[-0.5rem]">
                            ...
                            <div className="flex items-center">
                                ...
                                <p>
                                    ...
                                    <span className="text-gray-600">{marker.street.village.name}</span>
                                </p>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p>
                                    <span className="font-semibold text-gray-700">Jalan:</span>{' '}
                                    <span className="text-gray-600">{marker.street.name}</span>
                                </p>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p>
                                    <span className="font-semibold text-gray-700">Tipe Lampu:</span>{' '}
                                    <span className="text-gray-600">{marker.type}</span>
                                </p>
                            </div>
                ...
                if (mapRef.current) {
                    L.marker(LokasiLamp, { icon: defaultMarkerIcon(marker.icon.path_icon) })
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M15 3h6v6m0 0l-4.586-4.586M21 9l-4.586 4.586M9 21H3v-6m0 0l4.586 4.586M3 15l4.586-4.586"
                        />
                    </svg>
                </button>
            </div>
            <MapLeaflet mapRef={mapRef} zoom={zoom} center={center}>
                <Polyline positions={lamps.map((lamp) => [lamp.latitude, lamp.longitude])}></Polyline>
                {children}
            </MapLeaflet>
        </div>
    );
